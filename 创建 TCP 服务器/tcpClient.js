...
tcpClient.connect(PORT, HOST, function(){
        ...
        //if (data === 'wz\n')
        //{
	        var bufHead=Buffer.from([1]);
	        var bufData=Buffer.from("hello");
	        console.log(bufData);
	        var data=Buffer.concat([bufHead,bufData]);
	        tcpClient.write(data);
	    //}

        //if (data === 'wj\n')
        //{
	        var bufHead=Buffer.from([0]);
	        //var bufData=Buffer.from("hello");
	        var bufData=fs.readFileSync("input.txt");
	        console.log(bufData);
	        var data=Buffer.concat([bufHead,bufData]);
	        tcpClient.write(data);
	    //}
